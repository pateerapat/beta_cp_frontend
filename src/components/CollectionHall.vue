  ...
  <div class="container">
    <div class="container-fluid bg-main px-5 py-4">
      <div class="row mt-5 mx-1 gx-5">
        <h1 class="ff-chonburi fs-logo">HALL</h1>
        <p>Collection hall keep information about how many have been collected for each card per user.</p>
      </div>
...
export default {
  ...
  async created () {
    ...
    const result = (await UserService.funcGetAllCharacterCards()).data
